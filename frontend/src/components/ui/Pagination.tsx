  ...
  return (
    <nav className={cn("flex items-center justify-center", className)}>
      <button
        ...
        className="text-indigo-800 text-sm md:text-base rounded-sm hover:opacity-70 active:opacity-50 border-2 border-gray-100 shadow-lg p-1.25 md:p-2.5 disabled:text-stone-300 disabled:pointer-events-none cursor-pointer"
      >
        Previous
      </button>
